...
var App = function () {
    ...
    var handleSidebarAndContentHeight = function () {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            ...
            if (body.hasClass('page-sidebar-fixed')) {
                ...
                height = $(window).height() - $('.header').height() - $('.footer').height() -14;
            }
    ...
    var handleSidebarMenu = function () {
        jQuery('.page-sidebar').on('click', 'li > a', function (e,callback) {
                ...
                if (sub.is(":visible")) {
                    ...
                    if($(this).parent().children().hasClass("sub-menu")){
                ...
                //点击菜单时，切换至相应标签页
                var tabIdentify = $(this).attr("addTabs") == undefined ? $(this).find("span").attr("addTabs") : $(this).attr("addTabs");
                var tabs = $("#tab_tab_"+tabIdentify);
                var tabContent = $("#tab_"+tabIdentify);
    ...
    var handlePortletTools = function () {
        ...
        jQuery('body').on('click', '.sql-result .tools .glyphicon-chevron-down, .sql-result .tools .glyphicon-chevron-up', function (e) {
            e.preventDefault();
            var elParent = jQuery(this).closest(".sql-result");
            var el = jQuery(this).closest(".sql-result").children(".sql-result-container");
