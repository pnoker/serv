...
public class AesUtils {
    ...
    public static byte[] aesEncryptToBytes(String content, String encryptKey) throws NoSuchAlgorithmException,
        ...
        kgen.init(ENCRYPT_STRENGTH, new SecureRandom(encryptKey.getBytes()));
    ...
    public static String aesDecryptByBytes(byte[] encryptBytes, String decryptKey) throws NoSuchPaddingException,
        ...
        kgen.init(ENCRYPT_STRENGTH, new SecureRandom(decryptKey.getBytes()));
    ...
    public static String aesDecrypt(String encryptStr, String decryptKey) throws Exception {
        return StringUtils.isNullOrEmpty(encryptStr) ? null : aesDecryptByBytes(Base64Utils.decode(encryptStr),
                decryptKey);
    }
    ...
    public static String aesDecryptBySalt(String encryptStr, String salt) {
        ...
        try {
            ...
            decryptStr = StringUtils.isNullOrEmpty(encryptStr) ? null : aesDecryptByBytes(
    ...
    public static void main(String[] args) throws Exception {
        ...
        String result = AesUtils.aecEncryptBySalt(content, "登录名称317e39d5-cfd0-4e41-9c7e-6f91f627cfca");
        System.out.println("加密后：" + result);
        result = AesUtils.aesDecryptBySalt("GOKJ5oDed2ze95Fe/NkUNA==", "user11fe2ddd10-0f6c-44ff-b294-0146b249a349");
